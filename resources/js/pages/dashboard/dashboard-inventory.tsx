...
import { AlertCircle, ClipboardList, DollarSign, Package, ShoppingBag, TrendingUp, Truck, Users } from 'lucide-react';
...
interface DashboardInventorydProps extends PageProps {
...
export default function DashboardInventory() {
    ...
    } = usePage<DashboardInventorydProps>().props;
    ...
    return (
        <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div className="grid auto-rows-min gap-4 md:grid-cols-4">
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative col-span-2 overflow-hidden rounded-xl border p-6">
